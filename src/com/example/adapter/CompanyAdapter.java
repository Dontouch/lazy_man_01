...
import com.example.lazy_man_01.PlistserviceActivity;
...
class MyGridViewAdapter extends BaseAdapter implements OnClickListener{
	...
	public MyGridViewAdapter(Context context, CompanyCategory companyCategory,ExpandableListView listView) {
		super();
		this.context = context;
	...
	@Override
	public int getCount() {
		return companyCategory.getValue().size();
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		id = companyCategory.getValue().get(position).getId() + "";
		String imageUrl = companyCategory.getValue().get(position).getPic();
