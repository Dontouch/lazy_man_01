...
import com.example.util.NetUtil.Status;
...
public abstract class BaseWapperActivity extends Activity implements
		OnClickListener {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_home:
			startActivity(new Intent(BaseWapperActivity.this,
					HomeActivity.class));
			break;
	...
	private void loadBottomTab() {
		ImageView localImageView1 = (ImageView) super
				.findViewById(R.id.imgHome);
		this.home = localImageView1;
		ImageView localImageView2 = (ImageView) super
				.findViewById(R.id.imgClassify);
		this.classify = localImageView2;
		ImageView localImageView3 = (ImageView) super
				.findViewById(R.id.imgSearch);
		this.search = localImageView3;
		ImageView localImageView4 = (ImageView) super
				.findViewById(R.id.imgShoppingCar);
		this.shopCar = localImageView4;
		ImageView localImageView5 = (ImageView) super
				.findViewById(R.id.imgMore);
